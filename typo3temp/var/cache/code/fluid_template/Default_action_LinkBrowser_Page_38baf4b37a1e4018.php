<?php
class Default_action_LinkBrowser_Page_38baf4b37a1e4018 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [TYPO3Fluid\Fluid\ViewHelpers\Format\JsonViewHelper::renderStatic($arguments1, $renderChildrenClosure2, $renderingContext)]);
