<?php
class Default_action_PageLayout_PageModuleNoAccess_a5776c5a04e39190 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$renderChildrenClosure8 = ($arguments7['value'] !== null) ? function() use ($arguments7) { return $arguments7['value']; } : $renderChildrenClosure8;return TYPO3Fluid\Fluid\ViewHelpers\Format\JsonViewHelper::renderStatic($arguments7, $renderChildrenClosure8, $renderingContext);
};
