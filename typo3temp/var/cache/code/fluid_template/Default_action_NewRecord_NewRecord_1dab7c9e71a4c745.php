<?php
class Default_action_NewRecord_NewRecord_1dab7c9e71a4c745 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output15 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [TYPO3Fluid\Fluid\ViewHelpers\Format\CaseViewHelper::renderStatic($arguments18, $renderChildrenClosure19, $renderingContext)]);
